...
public class NoteController {
	...
	@PostMapping("/dm/note/add")
	@ResponseStatus(value = HttpStatus.CREATED)
    public ResponseEntity<Map<String,String>> addNewUserNote
    	(@RequestHeader Map<String, String> headers,@RequestBody NoteDto noteDto) {
		
		try {
			Map<String,String> responseMap=this.noteServiceImpl.addOrUpdate(noteDto);
			return ResponseEntity.status(HttpStatus.OK).body(responseMap);
